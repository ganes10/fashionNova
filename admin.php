    ...
    <div class="container">
        ...
        <div class="main">
            <div class="topbar">
                ...
                <div class="user">
                    <img src="images/user.png" alt="user-profile-img">
                </div>
            </div>
                ...
                <div class="recentOrders">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php
                            if (mysqli_num_rows($orderresult) > 0):
                                // Fetch rows in reverse order to display new orders on top
                                $rows = array_reverse(mysqli_fetch_all($orderresult, MYSQLI_ASSOC));
                                foreach ($rows as $row): ?>
                                    <tr>
                                        <td>
                ...
                <div class="recentCustomers">
                    ...
                    <table>
                        ...
                        if (mysqli_num_rows($customerresult) > 0):
                            // Fetch rows in reverse order to display new customers on top
                            $rows = array_reverse(mysqli_fetch_all($customerresult, MYSQLI_ASSOC));
                            foreach ($rows as $row): ?>
                                <tr>
                                    <td width="60px">
                                        <div class="imgBx"><img src="images/user.png" alt="customer-img"></div>
                                    </td>
                                    <td>
                                        <h4>
